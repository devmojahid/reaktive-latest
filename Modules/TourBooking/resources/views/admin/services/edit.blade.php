...
@push('style_section')
    ...
    <style>
        /* Integrare cu dev.css — folosim input styling global; doar utilitare locale aici */

        .flatpickr-months .flatpickr-month { height: 108px; }

        /* Currency adornment (fără a strica stilul input-ului din dev.css) */
...
/* împinge form-check complet la dreapta și aliniază conținutul lui pe un singur rând */
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            ...
                                            <input class="crancy__item-input" type="number" name="room_count" value="{{ old('room_count', $service->room_count) }}" placeholder="1">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            ...
                                            <input class="crancy__item-input timepicker-date" type="text" name="check_in_date" value="{{ old('check_in_date', $service->check_in_date) }}" placeholder="Select date" autocomplete="off">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            ...
                                            <input class="crancy__item-input timepicker-date" type="text" name="check_out_date" value="{{ old('check_out_date', $service->check_out_date) }}" placeholder="Select date" autocomplete="off">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            ...
                                            <input class="crancy__item-input timepicker" type="text" name="check_in_time" value="{{ old('check_in_time', $service->check_in_time) }}" placeholder="e.g. 14:00" autocomplete="off">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            ...
                                            <input class="crancy__item-input timepicker" type="text" name="check_out_time" value="{{ old('check_out_time', $service->check_out_time) }}" placeholder="e.g. 10:00" autocomplete="off">
